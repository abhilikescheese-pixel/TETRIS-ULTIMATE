...
figures =[
    ...
    [[1,4,5,6], [5,6,7,9], [2,6,10,11], [3,5,6,7]],
...
# loop until the suer clicks the close button
done = False
...
while not done:
    ...
    for i in range(game.height):
        pygame.draw.line(screen, GRAY, (game.x, game.y + game.zoom * i),
                         (game.x + game.zoom * game.width, game.y + game.zoom * i))
    for j in range(game.width):
        pygame.draw.line(screen, GRAY, (game.x + game.zoom * j, game.y),
                         (game.x + game.zoom * j, game.y + game.zoom * game.height))

    pygame.draw.rect(screen, WHITE, [game.x, game.y, game.zoom * game.width, game.zoom * game.height], 4)
